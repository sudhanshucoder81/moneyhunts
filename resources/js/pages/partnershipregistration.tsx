...
const staggerContainer = {
  ...
  return (
    <>
      ...
      <main>
        {/* HERO SECTION */}
      <section className="relative min-h-[85vh] overflow-hidden bg-[#FCFBFC] border-t border-[#d7e0e8]">
  <div className="max-w-7xl mx-auto px-6 lg:pl-6 lg:pr-0 py-16 lg:py-15">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-1 lg:gap-1 items-center pb-28 lg:pb-24">
      {/* LEFT CONTENT */}
      <motion.div
        className="max-w-3xl"
        initial="hidden"
      ...
      >
        ...
        >
          Start your partnership registration today and build your business
          with complete legal support. Our simple and affordable business
          registration process helps you register quickly, stay compliant,
          and grow confidently. Get expert assistance for partnership firm
          setup, documentation, GST, and PAN registration now.
        </motion.p>
      ...
      >
        ...
        >
          <img
            ...
            className="relative w-full h-auto max-h-[510px] object-cover rounded-[2px] shadow-xl"
          />
  ...
  <div className="w-28 h-1 bg-yellow-500 mt-3 mb-8 rounded-full mx-auto" />
</div>
